...
import com.social.media.repositories.SocialProfilePostRepository;
...
public class DataInitializer {
    ...
    private final SocialProfilePostRepository socialProfileRepository;
    private final PostRepository postRepository;

    public DataInitializer(SocialUserRepository userRepository, SocialGroupRepository groupRepository, SocialProfilePostRepository socialProfileRepository, PostRepository postRepository) {
